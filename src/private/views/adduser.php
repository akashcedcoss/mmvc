...
<main class="form-signin w-50 m-auto mt-5">
  <form action= "<?php $settings['siteurl'];?>/public/addnewuser" method="POST">
    ...
    <input type="submit" value="Add User" class="w-75 btn btn-lg border border-primary text-primary mt-4" name="submit"> 
